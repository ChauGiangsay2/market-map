  ...
  vendors = [
   {
      ...
      },
      {
        ...
        items: 'Cá lóc, cá rô',
        images: ['https://tepbac.com/upload/news/ge_image/2021/07/sap-ban-ca_1627544387.jpg'],
        rating: 4.3
      },
      {
...
findNearestMarket(lat: number, lon: number) {
  ...
  if (nearest) {
    alert(`🛍️ Gần bạn nhất: ${nearest.name} (${nearest.distance.toFixed(2)} km)
Có tổng cộng ${this.vendors.length} sạp trong chợ.`);
  }
}
